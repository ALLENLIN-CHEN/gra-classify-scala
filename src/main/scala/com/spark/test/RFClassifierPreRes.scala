...
object RFClassifierPreRes {
  def main(args: Array[String]) {
    ...
    val CFResult_DF = sqlContext.read.format("com.databricks.spark.csv").option("header","true").schema(gbt_schema).load("E:\\traindata\\GBTresult1.csv").drop("date_time")
    ...
    val output =new File("RF_GBT_result1.csv")
